...
class Sentiment:
    ...
    def fetch_sentiment(self):
        ...
        try:
            ...
            logger.info(f"Sentiment analysis completed for product: {self.product.title}")

        except requests.exceptions.RequestException as e:
            logger.error(f"API request failed for product: {self.product.title}. Error: {e}")
    ...
    def _process_results(self, results):
        ...
        for result in results:
            try:
                ...
                logger.warning(f"Missing expected key in result for product: {self.product.title}. Error: {e}")
